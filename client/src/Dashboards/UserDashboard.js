...
const rows = [
  createData(1,'Cupcake','pending..'),
  createData(2,'Nari','pending..'),
  createData(3,'Rahul','pending..'),
  createData(4,'Prathamesh','pending..'),
  createData(5,'Rhaa','pending..'),
  createData(6,'Cupcake','pending..'),
  createData(7,'Cupcake','pending..'),
  createData(8,'Cupcake','pending..'),
      ...
      <TableRow>
        ...
        {headCells.map((headCell) => (
          <TableCell  
            ...
            padding={headCell.disablePadding ? 'none' : '50%'}
