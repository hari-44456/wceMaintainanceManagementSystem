...
import { Button, FormControl, Grid, TextField, Typography, makeStyles } from '@material-ui/core';
...
export default function StoreMaterial() {
    ...
    return (
        <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
                <StoreMaterialTable storeMaterials={storeMaterials} data={materials} setData = {setMaterials} />
            </Grid>
        </Grid>
    )
