...
function createData(ID,title,date,status,Depart) {
  return { ID, title,date,status,Depart};
}

const data = [
  createData(1,'Repair','2021/02/03', 'Pending...','CSE'),
  createData(2,'Pipe','2021/01/05', 'Pending...','CSE'),
  createData(3,'Electrical','2021/02/03', 'Pending...','CSE'),
  createData(4,'Repair','2021/02/07', 'Pending...','CSE'),
  createData(5,'Pipe','2021/02/06', 'Pending...','CSE'),
  createData(6,'Electrical','2021/02/08', 'Pending...','CSE'),
  createData(7,'Repair','2021/02/09', 'Pending...','CSE'),
  createData(8,'Pipe','2021/02/03', 'Pending...','CSE'),
  createData(9,'Electrical','2021/05/03', 'Pending...','CSE'),
  createData(10,'Repair','2021/06/03', 'Pending...','CSE'),
  createData(11,'Pipe','2021/02/05', 'Pending...','CSE'),
  createData(12,'Electrical','2021/02/06', 'Pending...','CSE'),
];
  ...
  return (
     ...
     <div style={{ width: '150%' }}>
      ...
      <Dialog disableBackdropClick disableEscapeKeyDown open={open} onClose={handleClose}>
        ...
        <Box p={1} bgcolor="grey.300">
        <Button size="large" variant="contained" color="primary"><AddIcon></AddIcon>New Complaint</Button>
        </Box>
      </Box>
